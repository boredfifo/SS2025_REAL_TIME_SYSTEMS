...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{background_servicing.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{polling_server.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{pe_server_example.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{pe_server_schedule.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{PE_server_budget.png}
